# materials_sec1
# Concrete 6 ksi, Residential
if {$dispflag} {puts "\nmaterials_sec_28_6 story$story"}; puts $recInput "\nmaterials_sec_28_6 story$story"

set prVerW 0.01427;	#Longitudinal reinforcement ratio of Web
set prVerF 0.01227;	#Longitudinal reinforcement ratio of flange
set prVerC 0.01851;	#Longitudinal reinforcement ratio of corner element
set prVerB 0.01697;	#Longitudinal reinforcement ratio of boundary element
...
set fc -7.8;			#Same as Etabs model
#set fc -6.;			#Same as Etabs model
set Eco [expr 33000.*pow(0.140 + abs($fc)/1000.,1.5)*pow(abs($fc),0.5)];	#Tadros et al 2003 K1=K2=1.0
set Ec $Eco
set ec [expr 2.*$fc/$Ec]
set fr [expr {5.7*sqrt(7800.)*$psi}];	#Legeron et al 2000
set et [expr {$fr/$Ec}]
