...
#set w1 [expr 2.*$pi/1.4]
#set w2 [expr 2.*$pi/0.3]
...
#set gmFact_V [expr $g*$scaleFac_V];		# data in input file is in units of g
...
#timeSeries Path $tsTag_V -dt $dtRec -values $gmDataInput_V -factor $gmFact_V;
...
#pattern UniformExcitation  $gmLoadTag_V  $gm_dirctn_V -accel  $tsTag_V;		# create Uniform excitation
