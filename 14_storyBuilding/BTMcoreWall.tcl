# coreWallBTM
proc coreWallBTM {story outputDir materials sections nStory path hPier hPanel nIncPierZ nIncCShapeZbelow xo yo zo CWtag ModelFile Nodes inputFile tagModel modelType} {
