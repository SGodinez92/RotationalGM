...
pattern Plain $patternTagGravity "Linear" {
	for {set i 1} {$i <= $nStory} {incr i 1} {
		...
		# Column loads
		load [expr 1000*$i + 800 +  1] 0. 0. [expr -$w_tot*$ft*$ft*198.0] 0. 0. 0.
		load [expr 1000*$i + 800 +  2] 0. 0. [expr -$w_tot*$ft*$ft*429.0] 0. 0. 0.
		load [expr 1000*$i + 800 +  3] 0. 0. [expr -$w_tot*$ft*$ft*495.0] 0. 0. 0.
		load [expr 1000*$i + 800 +  4] 0. 0. [expr -$w_tot*$ft*$ft*264.0] 0. 0. 0.
		load [expr 1000*$i + 800 +  5] 0. 0. [expr -$w_tot*$ft*$ft*342.0] 0. 0. 0.
		load [expr 1000*$i + 800 +  6] 0. 0. [expr -$w_tot*$ft*$ft*591.0] 0. 0. 0.
		load [expr 1000*$i + 800 +  7] 0. 0. [expr -$w_tot*$ft*$ft*342.0] 0. 0. 0.
		load [expr 1000*$i + 800 +  8] 0. 0. [expr -$w_tot*$ft*$ft*591.0] 0. 0. 0.
		load [expr 1000*$i + 800 +  9] 0. 0. [expr -$w_tot*$ft*$ft*198.0] 0. 0. 0.
		load [expr 1000*$i + 800 + 10] 0. 0. [expr -$w_tot*$ft*$ft*429.0] 0. 0. 0.
		load [expr 1000*$i + 800 + 11] 0. 0. [expr -$w_tot*$ft*$ft*495.0] 0. 0. 0.
		load [expr 1000*$i + 800 + 12] 0. 0. [expr -$w_tot*$ft*$ft*264.0] 0. 0. 0.
		load [expr 1000*$i + 800 + 13] 0. 0. [expr -$w_tot*$ft*$ft*135.0] 0. 0. 0.
		load [expr 1000*$i + 800 + 14] 0. 0. [expr -$w_tot*$ft*$ft*135.0] 0. 0. 0.
	}
}
