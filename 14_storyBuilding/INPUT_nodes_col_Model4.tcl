...
for {set i 0} {$i <= $nStory} {incr i 1} {
	...
	node [expr $nodeTag + 10] [expr 31.*$ft] [expr 90.*$ft] $z
	node [expr $nodeTag + 11] [expr 59.*$ft] [expr 90.*$ft] $z
	node [expr $nodeTag + 12] [expr 90.*$ft] [expr 90.*$ft] $z
	...
	puts $ModelFile "node [expr $nodeTag + 10] [expr 31.*$ft] [expr 90.*$ft] $z"
	puts $ModelFile "node [expr $nodeTag + 11] [expr 59.*$ft] [expr 90.*$ft] $z"
	puts $ModelFile "node [expr $nodeTag + 12] [expr 90.*$ft] [expr 90.*$ft] $z"
