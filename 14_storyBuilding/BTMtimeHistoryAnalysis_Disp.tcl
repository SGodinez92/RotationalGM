...
#set gmDataFile_L [open "GroundMotions/$EQlevel/H1_D_KHMN.dat" "r"];	Displacement input
#set gmDataFile_T [open "GroundMotions/$EQlevel/H2_D_KHMN.dat" "r"];	Displacement input
set gmDataFile_L [open "GroundMotions/$EQlevel/H1_KHMN.dat" "r"];#		Acceleration input
set gmDataFile_T [open "GroundMotions/$EQlevel/H2_KHMN.dat" "r"];#		Acceleration input

set gmDataFile_RotY [open "GroundMotions/$EQlevel/RotY_KHMN.dat" "r"];
set gmDataFile_RotX [open "GroundMotions/$EQlevel/RotX_KHMN.dat" "r"];
set gmDataFile_RotZ [open "GroundMotions/$EQlevel/RotZ_KHMN.dat" "r"];
...
timeSeries Path $tsTag_L -dt $dtRec -values $gmDataInput_L -factor $g; # define displacement vector from file (displacement already in inches), use $g if using the acceleration input
timeSeries Path $tsTag_T -dt $dtRec -values $gmDataInput_T -factor $g; # define displacement vector from file (displacement already in inches), use $g if using the acceleration input
