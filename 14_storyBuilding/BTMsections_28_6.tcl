...
set prVerW 0.0071;	#Longitudinal reinforcement ratio of Web
set prVerF 0.0070;	#Longitudinal reinforcement ratio of flange
set prVerC 0.0162;	#Longitudinal reinforcement ratio of corner element
set prVerB 0.0178;	#Longitudinal reinforcement ratio of boundary element
set prHorX 0.0055;	#Horizontal reinforcement ratio
set prHorY 0.0037;	#Horizontal reinforcement ratio
...
set zRebar 10.0
#proc boundSecFiber {secTag bSec hSec Ec cov eccY eccZ yRebar zRebar AbSec prDum concCover concCore steel nFiberSteelY nFiberSteelZ eMat fGJ}
boundSecFiber $sec_cxPibfW1 $bSec $hSec $Ec $cov $eccY $eccZ $yRebar $zRebar $AbSec $prDum $uconcv_pier $cconcb_pier $SteelMatTag 6 4 $eMat $fGJ
puts $recInput "boundSecFiber $sec_cxPibfW1 $bSec $hSec $Ec $cov $eccY $eccZ $yRebar $zRebar $AbSec $prDum $uconcv_pier $cconcb_pier $SteelMatTag 6 4 $eMat $fGJ"
...
set zRebar 10.0
#proc boundSecFiber {secTag bSec hSec Ec cov eccY eccZ yRebar zRebar AbSec prDum concCover concCore steel nFiberSteelY nFiberSteelZ eMat fGJ}
boundSecFiber $sec_cxPibfE1 $bSec $hSec $Ec $cov $eccY $eccZ $yRebar $zRebar $AbSec $prDum $uconcv_pier $cconcb_pier $SteelMatTag 6 4 $eMat $fGJ
puts $recInput "boundSecFiber $sec_cxPibfE1 $bSec $hSec $Ec $cov $eccY $eccZ $yRebar $zRebar $AbSec $prDum $uconcv_pier $cconcb_pier $SteelMatTag 6 4 $eMat $fGJ"
...
set zRebar 10.0
#proc boundSecFiber {secTag bSec hSec Ec cov eccY eccZ yRebar zRebar AbSec prDum concCover concCore steel nFiberSteelY nFiberSteelZ eMat fGJ}
boundSecFiber $sec_cxPabfW1 $bSec $hSec $Ec $cov $eccY $eccZ $yRebar $zRebar $AbSec $prDum $uconcv_panel $cconcb_panel $SteelMatTag 6 4 $eMat $fGJ
puts $recInput "boundSecFiber $sec_cxPabfW1 $bSec $hSec $Ec $cov $eccY $eccZ $yRebar $zRebar $AbSec $prDum $uconcv_panel $cconcb_panel $SteelMatTag 6 4 $eMat $fGJ"
...
set zRebar 10.0
#proc boundSecFiber {secTag bSec hSec Ec cov eccY eccZ yRebar zRebar AbSec prDum concCover concCore steel nFiberSteelY nFiberSteelZ eMat fGJ}
boundSecFiber $sec_cxPabfE1 $bSec $hSec $Ec $cov $eccY $eccZ $yRebar $zRebar $AbSec $prDum $uconcv_panel $cconcb_panel $SteelMatTag 6 4 $eMat $fGJ
puts $recInput "boundSecFiber $sec_cxPabfE1 $bSec $hSec $Ec $cov $eccY $eccZ $yRebar $zRebar $AbSec $prDum $uconcv_panel $cconcb_panel $SteelMatTag 6 4 $eMat $fGJ"
