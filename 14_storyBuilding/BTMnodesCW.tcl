...
# coupling beams
proc nodesCB {xoCB yoCB zoCB lCshapeX sCshape lCB hPier lCshapeZ coreWallTag cbTag compLeftTag compRightTag nIncCShapeX nIncPierZ nIncCShapeZ recInput story} {
set Nodes {}
...
append Nodes { } [nodesCB $xoCB $yoCB $zoCB $lCshapeX $sCshape $lCB $hPier $lCshapeZ $coreWallTag $cbTag $compLeftTag $compRightTag $nIncCShapeX $nIncPierZ $nIncCShapeZ $recInput $story]
...
node [expr {$coreWallTag + $cbTag + 16}] [expr {$xoCB + $incCshapeX*4}] $yoCB [expr {$zoCB + $incPierZ*4}]
node [expr {$coreWallTag + $cbTag + 17}] [expr {$xoCB + $incCshapeX*4}] $yoCB [expr {$zoCB + $incPierZ*4 + 21.}]
node [expr {$coreWallTag + $cbTag + 18}] [expr {$xoCB + $incCshapeX*4}] $yoCB [expr {$zoCB + $incPierZ*5}]
node [expr {$coreWallTag + $cbTag + 19}] [expr {$xoCB + $lCshapeX + $sCshape + $incCshapeX}] $yoCB [expr {$zoCB + $incPierZ*4}]
node [expr {$coreWallTag + $cbTag + 20}] [expr {$xoCB + $lCshapeX + $sCshape + $incCshapeX}] $yoCB [expr {$zoCB + $incPierZ*4 + 21.}]
node [expr {$coreWallTag + $cbTag + 21}] [expr {$xoCB + $lCshapeX + $sCshape + $incCshapeX}] $yoCB [expr {$zoCB + $incPierZ*5}]

} else {

node [expr {$coreWallTag + $cbTag + 16}] [expr {$xoCB + $incCshapeX*4}] $yoCB [expr {$zoCB + $incPierZ*3}]
node [expr {$coreWallTag + $cbTag + 17}] [expr {$xoCB + $incCshapeX*4}] $yoCB [expr {$zoCB + $incPierZ*3 + 17.125}]
node [expr {$coreWallTag + $cbTag + 18}] [expr {$xoCB + $incCshapeX*4}] $yoCB [expr {$zoCB + $incPierZ*4}]
node [expr {$coreWallTag + $cbTag + 19}] [expr {$xoCB + $lCshapeX + $sCshape + $incCshapeX}] $yoCB [expr {$zoCB + $incPierZ*3}]
node [expr {$coreWallTag + $cbTag + 20}] [expr {$xoCB + $lCshapeX + $sCshape + $incCshapeX}] $yoCB [expr {$zoCB + $incPierZ*3 + 17.125}]
node [expr {$coreWallTag + $cbTag + 21}] [expr {$xoCB + $lCshapeX + $sCshape + $incCshapeX}] $yoCB [expr {$zoCB + $incPierZ*4}]

node [expr {$coreWallTag + $cbTag + 22}] [expr {$xoCB + $incCshapeX*4}] $yoCB $zoCB
node [expr {$coreWallTag + $cbTag + 23}] [expr {$xoCB + $incCshapeX*4}] $yoCB [expr {$zoCB + 11.75}]
...
node [expr {$coreWallTag + $cbTag + 26}] [expr {$xoCB + $lCshapeX + $sCshape + $incCshapeX}] $yoCB [expr {$zoCB + 11.75}]
...
equalDOF [expr {$coreWallTag + $compLeftTag  + 33}] [expr {$coreWallTag + $cbTag + 16}] 1 2 3 4 6
equalDOF [expr {$coreWallTag + $compLeftTag  + 34}] [expr {$coreWallTag + $cbTag + 18}] 1 2 3 4 6
equalDOF [expr {$coreWallTag + $compRightTag + 12}] [expr {$coreWallTag + $cbTag + 19}] 1 2 3 4 6
equalDOF [expr {$coreWallTag + $compRightTag + 13}] [expr {$coreWallTag + $cbTag + 21}] 1 2 3 4 6
...
equalDOF [expr {$coreWallTag + $compRightTag + 10}] [expr {$coreWallTag + $cbTag + 19}] 1 2 3 4 6
equalDOF [expr {$coreWallTag + $compRightTag + 11}] [expr {$coreWallTag + $cbTag + 21}] 1 2 3 4 6

equalDOF [expr {$coreWallTag + $compLeftTag  -100000 + 35}] [expr {$coreWallTag + $cbTag + 22}] 1 2 3 4 6
equalDOF [expr {$coreWallTag + $compLeftTag  + 26}] [expr {$coreWallTag + $cbTag + 24}] 1 2 3 4 6
equalDOF [expr {$coreWallTag + $compRightTag -100000 + 14}] [expr {$coreWallTag + $cbTag + 25}] 1 2 3 4 6
equalDOF [expr {$coreWallTag + $compRightTag +  8}] [expr {$coreWallTag + $cbTag + 27}] 1 2 3 4 6
...
equalDOF [expr {$coreWallTag + $compLeftTag  -100000 + 30}] [expr {$coreWallTag + $cbTag + 22}] 1 2 3 4 6
equalDOF [expr {$coreWallTag + $compLeftTag  + 26}] [expr {$coreWallTag + $cbTag + 24}] 1 2 3 4 6
equalDOF [expr {$coreWallTag + $compRightTag -100000 + 12}] [expr {$coreWallTag + $cbTag + 25}] 1 2 3 4 6
equalDOF [expr {$coreWallTag + $compRightTag +  8}] [expr {$coreWallTag + $cbTag + 27}] 1 2 3 4 6
