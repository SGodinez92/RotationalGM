...
pattern Plain $patternTagGravity "Linear" {
	for {set i 1} {$i <= $nStory} {incr i 1} {
		...
		load [expr 1000*$i + 800 +  2] 0. 0. [expr -$w_tot*$ft*$ft*626.75] 0. 0. 0.
		load [expr 1000*$i + 800 +  3] 0. 0. [expr -$w_tot*$ft*$ft*626.75] 0. 0. 0.
		...
		load [expr 1000*$i + 800 +  7] 0. 0. [expr -$w_tot*$ft*$ft*393.31] 0. 0. 0.
		load [expr 1000*$i + 800 +  8] 0. 0. [expr -$w_tot*$ft*$ft*393.31] 0. 0. 0.
		load [expr 1000*$i + 800 +  9] 0. 0. [expr -$w_tot*$ft*$ft*207.31] 0. 0. 0.
		load [expr 1000*$i + 800 + 10] 0. 0. [expr -$w_tot*$ft*$ft*394.56] 0. 0. 0.
		load [expr 1000*$i + 800 + 11] 0. 0. [expr -$w_tot*$ft*$ft*394.56] 0. 0. 0.
		load [expr 1000*$i + 800 + 12] 0. 0. [expr -$w_tot*$ft*$ft*207.31] 0. 0. 0.
		load [expr 1000*$i + 800 + 13] 0. 0. [expr -$w_tot*$ft*$ft*140.00] 0. 0. 0.
		load [expr 1000*$i + 800 + 14] 0. 0. [expr -$w_tot*$ft*$ft*140.00] 0. 0. 0.
	}
}
