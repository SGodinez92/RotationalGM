...
for {set i 3} {$i < $nStory} {incr i} {
	...
	if {$i == $nStory} {
		...
		mass [expr 1000*$i + 800 + 13] [expr 28.*$in*28.*$in*6.*$ft*150.*$pcf/$g] [expr 28.*$in*28.*$in*6.*$ft*150.*$pcf/$g] 0. 0. 0. 0.
		mass [expr 1000*$i + 800 + 14] [expr 28.*$in*28.*$in*6.*$ft*150.*$pcf/$g] [expr 28.*$in*28.*$in*6.*$ft*150.*$pcf/$g] 0. 0. 0. 0.
		...
		mass [expr 1000*$i + 800 + 13] [expr 28.*$in*28.*$in*14.*$ft*150.*$pcf/$g] [expr 28.*$in*28.*$in*14.*$ft*150.*$pcf/$g] 0. 0. 0. 0.
		mass [expr 1000*$i + 800 + 14] [expr 28.*$in*28.*$in*14.*$ft*150.*$pcf/$g] [expr 28.*$in*28.*$in*14.*$ft*150.*$pcf/$g] 0. 0. 0. 0.
		...
		mass [expr 1000*$i + 800 + 13] [expr 28.*$in*28.*$in*12.*$ft*150.*$pcf/$g] [expr 28.*$in*28.*$in*12.*$ft*150.*$pcf/$g] 0. 0. 0. 0.
		mass [expr 1000*$i + 800 + 14] [expr 28.*$in*28.*$in*12.*$ft*150.*$pcf/$g] [expr 28.*$in*28.*$in*12.*$ft*150.*$pcf/$g] 0. 0. 0. 0.
