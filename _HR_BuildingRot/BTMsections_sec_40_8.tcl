...
# definitions
set tWall 40;								#Thickness of the core wall
...
set prVerW 0.00982;	#Longitudinal reinforcement ratio of Web
set prVerF 0.00785;	#Longitudinal reinforcement ratio of flange
set prVerC 0.01320;	#Longitudinal reinforcement ratio of corner element
set prVerB 0.02277;	#Longitudinal reinforcement ratio of boundary element
...
set hSec [expr {$incPierZ/2. + $incPanelZ/2.}]
set AbSec [expr {$bSec*$hSec*$prHorX/2.}]
set A_string [expr 40.*$AbNo10/2.];	# Add stringer area to the wall at slab level to carry drag forces
...
if {$story < 4} {
	...
	set AsDiaCB [expr 12.*$AbNo11]
} else {
	set AsDiaCB [expr 12.*$AbNo10]
}
