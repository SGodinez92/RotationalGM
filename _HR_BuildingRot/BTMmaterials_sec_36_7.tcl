# materials_sec1
# Concrete 7 ksi, Office
if {$dispflag} {puts "\nmaterials_sec_36_7 story$story"}; puts $recInput "\nmaterials_sec_36_7 story$story"
...
set fc -9.1;			#Same as Etabs model
#set fc -7.;			#Same as Etabs model
set Eco [expr 33000.*pow(0.140 + abs($fc)/1000.,1.5)*pow(abs($fc),0.5)];	#Tadros et al 2003 K1=K2=1.0
set Ec $Eco
set ec [expr 2.*$fc/$Ec]
set fr [expr {5.7*sqrt(9100.)*$psi}];	#Legeron et al 2000
set et [expr {$fr/$Ec}]
