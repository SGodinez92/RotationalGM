...
#set gmDataFile_L [open "GroundMotions/$EQlevel/H1_KHMN.dat" "r"];
#set gmDataFile_T [open "GroundMotions/$EQlevel/H2_KHMN.dat" "r"];

#set gmDataFile_RotX [open "GroundMotions/$EQlevel/RotX_D_KHMN.dat" "r"];
#set gmDataFile_RotY [open "GroundMotions/$EQlevel/RotY_D_KHMN.dat" "r"];
#set gmDataFile_RotZ [open "GroundMotions/$EQlevel/RotZ_D_KHMN.dat" "r"];
...
set w2 [expr 2*$pi/0.7];			# Second translational mode3
